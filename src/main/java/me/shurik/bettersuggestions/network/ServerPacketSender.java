...
public class ServerPacketSender {
    public static void sendEntityCommandTagsResponse(ServerPlayer player, int entityId, Set<String> commandTags) {
    ...
    public static void sendEntityScoresResponse(ServerPlayer player, int entityId, Collection<ScoreboardScoreContainer> scores) {
        if (ModConstants.DEBUG) {
